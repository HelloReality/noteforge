// NoteForge — public viewer actions (print, copy link, back to library).
'use client'

import { useState } from 'react'
import Link from 'next/link'
import { Printer, Link2, ArrowLeft, Loader2 } from 'lucide-react'
import { Button } from '@/components/ui/button'
import { toast } from 'sonner'

export function PublicViewerActions({ slug }: { slug: string }) {
